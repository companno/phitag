        ...
        <Layout>
            ...
            <SingleContentLayout>
                ...
                <div className="mt-2 xl:mt-10">
                        <UseRankPairTutorialAnnotation instance={instances.data[tutorialAnnotation.currentAnnotation] as UseRankPairInstance} handleSubmitAnnotation={handleSubmitAnnotation} /> 
                </div>
