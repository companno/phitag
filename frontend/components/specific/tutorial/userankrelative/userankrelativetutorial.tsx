        ...
        <Layout>
            ...
            <SingleContentLayout>
                ...
                <div className="mt-2 xl:mt-10">
                        <UseRankRelativeTutorialAnnotation instance={instances.data[tutorialAnnotation.currentAnnotation] as UseRankRelativeInstance} handleSubmitAnnotation={handleSubmitAnnotation} /> 
                </div>
