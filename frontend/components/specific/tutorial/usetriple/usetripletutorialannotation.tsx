...
interface IUseTripleAnnotationInstance {
    instance: UseTripleInstance;

    handleSubmitAnnotation: (judgement: string, comment: string) => void;
}

const UseTripleTutorialAnnotation: React.FC<IUseTripleAnnotationInstance> = ({ instance, handleSubmitAnnotation }) => {
...
export default UseTripleTutorialAnnotation;
