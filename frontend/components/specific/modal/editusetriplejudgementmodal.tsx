...
// model
import UseTripleJudgement from "../../../lib/model/judgement/usetriplejudgement/model/UseTripleJudgement";
import EditUseTripleJudgementCommand from "../../../lib/model/judgement/usetriplejudgement/command/EditUseTripleJudgementCommand";
import { editUsetriple } from "../../../lib/service/judgement/JudgementResource";
import DropdownSelect from "../../generic/dropdown/dropdownselect";
import DummySelectable from "../../../lib/model/dummy/DummySelectable";

interface EditUseTripleJudgementModalProps {
...
const EditUseTripleJudgementModal: React.FC<EditUseTripleJudgementModalProps> = ({ judgement, isOpen, closeModalCallback, mutateCallback }) => {
    ...
    const onConfirm = () => {
        ...
        const command: EditUseTripleJudgementCommand = new EditUseTripleJudgementCommand(
        ...
        editUsetriple(command, storage.get).then(() => {
...
export default EditUseTripleJudgementModal;
