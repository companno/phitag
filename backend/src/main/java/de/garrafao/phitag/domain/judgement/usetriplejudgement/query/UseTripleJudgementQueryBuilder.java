package de.garrafao.phitag.domain.judgement.usetriplejudgement.query;
...
public class UseTripleJudgementQueryBuilder {

    private final List<QueryComponent> queryComponents;

    public UseTripleJudgementQueryBuilder() {
        this.queryComponents = new ArrayList<>();
    }

    public UseTripleJudgementQueryBuilder withUUID(final String UUID) {
    ...
    public UseTripleJudgementQueryBuilder withAnnotator(final String annotator) {
    ...
    public UseTripleJudgementQueryBuilder withInstanceid(final String instanceid) {
    ...
    public UseTripleJudgementQueryBuilder withOwner(final String owner) {
    ...
    public UseTripleJudgementQueryBuilder withProject(final String project) {
    ...
    public UseTripleJudgementQueryBuilder withPhase(final String phase) {
