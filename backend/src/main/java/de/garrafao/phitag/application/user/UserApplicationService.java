...
import de.garrafao.phitag.application.user.data.UsernameRestrictionEnum;
...
import de.garrafao.phitag.domain.user.error.PrivacyPolicyNotAcceptedException;
...
import de.garrafao.phitag.domain.user.error.UsernameRestrictionException;
...
public class UserApplicationService {
     ...
     * 
     * @param queryfield The field to query using fuzzy search.
