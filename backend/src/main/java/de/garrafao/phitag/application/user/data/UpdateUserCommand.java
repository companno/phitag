...
public class UpdateUserCommand {
    ...
    public UpdateUserCommand(final String newUsername, final String newEmail, final String newPassword, final String newVisibility, final Set<String> newLanguages, final String newDescription, final String currentPassword) {   
        ...
        Validate.notNull(newVisibility, "newPassword must not be null");
