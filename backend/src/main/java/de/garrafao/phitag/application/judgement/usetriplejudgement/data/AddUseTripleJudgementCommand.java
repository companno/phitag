...
@Getter
public class AddUseTripleJudgementCommand implements IAddJudgementCommand {
    ...
    public AddUseTripleJudgementCommand(String owner, String project, String phase, String instance, String label,
            String comment) {
